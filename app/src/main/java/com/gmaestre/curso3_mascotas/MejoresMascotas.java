package com.gmaestre.curso3_mascotas;
...
public class MejoresMascotas extends AppCompatActivity {
    ...
    public List<ModeloMascota> obtenerMascota() {
        ...
        mascota.add(new ModeloMascota("Max", R.drawable.dog));
        mascota.add(new ModeloMascota("Charlie", R.drawable.cat));
        mascota.add(new ModeloMascota("Luna", R.drawable.dog));
        mascota.add(new ModeloMascota("Jack", R.drawable.cat));
        mascota.add(new ModeloMascota("Milo", R.drawable.dog));
        mascota.add(new ModeloMascota("Bailey", R.drawable.cat));
        return mascota;
    }
}